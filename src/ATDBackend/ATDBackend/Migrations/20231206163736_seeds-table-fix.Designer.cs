...
namespace ATDBackend.Migrations
{
    ...
    [Migration("20231206163736_seeds-table-fix")]
    partial class seedstablefix
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ATDBackend.Database.Models.SeedCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("ATDBackend.Database.Models.Seed", b =>
                {
                    b.HasOne("ATDBackend.Database.Models.Category", null)
                        .WithMany("Seeds")
                    ...
                    b.HasOne("ATDBackend.Database.Models.Order", null)
                        .WithMany("Seeds")
